  ...
  return (
    <Autocomplete
      ...
      if (!newValue){
        ...
        jobSearchFilterFunc(props?.selectedCategoery?.id ,null, props.selectedLocation ,props.setFilteredJobs);  
      }
      else{
        props.setIsFilter(true);
          jobSearchFilterFunc(props?.selectedCategoery?.id, newValue.job_title_slug, props.selectedLocation ,props.setFilteredJobs);
      }
